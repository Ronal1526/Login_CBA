    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        if (showSplashScreen.value) {
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ic_logo_cba),
                    contentDescription = null
                )
                if (showLoginForm.value) {
                    Text(text = "Inicia Sesión", style = TextStyle(fontWeight = FontWeight.Bold, fontSize = 20.sp))
                    UserForm(isCreateAccount = false) { email, password ->
                        Log.d("TiendaApp", "Inicio sesion con $email y $password")
                    }
                } else {
                    Text(text = "Crear Cuenta Nueva", style = TextStyle(fontWeight = FontWeight.Bold, fontSize = 20.sp))
        ...
        SubmitButtom(
            ...
            if (isCreateAccount) {
                notificacionImagen(
                    ...
                    idChannel,
                    idNotification + 2,
                    "Usted ha sido registrado con exito",
                    textLong,
                    iconoBig,
                    imagenBig
                )
                ...
                notificacionSencilla(
                    ...
                    idChannel,
                    idNotification,
                    "Bienvenido a nuestra tienda CBA",
                    textShort
                )
            }
        }
